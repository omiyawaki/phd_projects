function savedir = make_savedir_proc_ep(type, par)
    if any(strcmp(type, {'era5', 'era5c', 'erai', 'merra2', 'merra2c', 'jra55'}))
    ...
    elseif strcmp(type, 'gcm')
        foldername = sprintf('/project2/tas1/miyawaki/projects/002/data/proc/%s/%s/%s/%s/%s/eps_%g_ga_%g/', type, par.model, par.(type).clim, par.(type).yr_span, par.lat_interp, par.ep, par.ga);
