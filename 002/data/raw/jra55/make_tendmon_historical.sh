...
if ls $cwd/tendmon/${rea}_tend_${yr_begin}_${yr_end}.nc 1> /dev/null 2>&1; then # check if data is already there
    ...
    full_ps=${cwd}/srfc/${rea}_pres_${yr_begin}_${yr_end}.nc
    full_tas=${cwd}/srfc/${rea}_tmp_${yr_begin}_${yr_end}.nc
    full_huss=${cwd}/srfc/${rea}_huss_${yr_begin}_${yr_end}.nc
    full_orog=${cwd}/srfc/${rea}_orog_${yr_begin}_${yr_end}.nc
    full_ta=${cwd}/temp_trop/${rea}_tmp_${yr_begin}_${yr_end}.nc
    full_zg=${cwd}/zg_trop/${rea}_hgt_${yr_begin}_${yr_end}.nc
    full_hus=${cwd}/hus_trop/${rea}_spfh_${yr_begin}_${yr_end}.nc
