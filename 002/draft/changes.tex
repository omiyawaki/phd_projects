...
Quantifying the link between energy balance and lapse rate regimes would also allow us to better understand the regional response to CO$_2$ forcing. For example, regions of RCE that exhibit a moist adiabatic lapse rate will have amplified warming aloft in response to increased CO$_2$ \citep{held1993, romps2011, payne2015}. In contrast, regions of RAE that exhibit a surface inversion will have amplified warming at the surface in response to increased CO$_2$ \citep{held1993, payne2015, cronin2016}.\added{ Thus, the geographic and seasonal structure of energy balance regimes in a mean state climate can be used to make predictions of the vertical structure of warming.}
