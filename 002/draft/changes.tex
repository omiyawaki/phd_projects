...
\section{Testing hypotheses to explain seasonal\added{ energy balance} regime transitions\deleted{ using idealized climate models}} \label{sec:hypo}
  ...
  \end{equation}
  where $Q^*$ is the seasonal amplitude of insolation and $\omega=2\pi$ yr$^{-1}$. \replaced{Thus, the EBM predicts an analytic dependence of}{According to equation~(\ref{eq:r1-linear4}),} the amplitude of $\Delta R_1$ \replaced{on}{decreases as} the mixed layer depth $d$\deleted{ increases if all else is equal}. 
  ...
  \added{When AQUA is configured with sea ice, a high latitude regime transition occurs and is sensitive to the mixed layer depth (colored lines intersect blue region in Fig.~\ref{fig:echam-rae-mld}a). In particular, the duration of RCAE is shorter for a shallower mixed layer depth. The RAE regime transition coincides with the transition to a surface inversion lapse rate regime (colored lines overlapping the white region in Fig.~\ref{fig:echam-rae-mld}b). Whereas the timing of RCAE and inversion-free regimes exhibited a discrepancy in the reanalyses (Fig.~\ref{fig:rea-r1-ga-temporal}b), no such discrepancy occurs in AQUA with ice (compare Fig.~\ref{fig:echam-rae-mld}a and \ref{fig:echam-rae-mld}b). This suggests that physical mechanisms that are missing in AQUA, such as zonal asymmetry in sea ice properties or sea ice dynamics, may be necessary to understand the discrepancy between energy balance and lapse rate regimes in the Northern high latitudes.}

  \added{When AQUA is configured without sea ice, a high latitude regime transition only occurs for the shallowest (3 m) mixed layer depth (Fig.~\ref{fig:echam-rae-mld}c) and coincides with a surface inversion lapse rate regime transition (Fig.~\ref{fig:echam-rae-mld}d). However, the RAE regime transition occurs during the spring equinox and is not consistent with that seen in reanalyses data. Thus, the AQUA simulations suggest sea ice is required to capture a regime transition that is representative of that seen in reanalysis data. Furthermore, the role of sea ice is primarily via its effect on surface heat capacity since a regime transition is mostly insensitive to the surface albedo (not shown).}
  
  % When AQUA is configured with a 40 m mixed layer depth with sea ice, the high latitudes undergo a regime transition from RCAE to RAE (black line intersects the blue region in Fig.~\ref{fig:echam-rae-40}b). The boundary layer lapse rate deviation shows that an inversion exists when the high latitudes are in RAE but disappears when the high latitudes are in RCAE (blue line overlapping the white region in Fig.~\ref{fig:echam-rae}b). Furthermore, the latent heat flux seasonality with sea ice is consistent with small values during winter and an increase during summer (Fig.~\ref{fig:echam-rae}d). Thus, AQUA configured with sea ice captures the observed energy balance and lapse rate regime seasonality of the Northern high latitudes (compare Fig.~\ref{fig:echam-rae}b to \ref{fig:rea-r1-ga-temporal}b and \ref{fig:echam-rae}d to \ref{fig:rea-r1-decomp-pole}b).
...
\added{Here, we quantify whether modern energy balance regimes provide a useful guide to the vertical, latitudinal, and seasonal structure of the response to global warming. In particular, one would expect upper tropospheric amplified warming for columns in RCE and surface amplified warming for RAE. Since the temperature profile of regions in RCE are to first order convectively neutral regardless of the value of $R_1$, we expect columns currently in RCE to exhibit upper tropospheric amplified warming as long as it remains in RCE under climate change. On the other hand, the temperature profile of regions in RAE, as shown by \cite{cronin2016}, are sensitive to the profile of advective heating and surface heat fluxes. Thus, the temperature response over modern regions of RAE may be sensitive to changes in $R_1$ even if it remains in RAE under climate change.}

\added{In the annual mean, the CMIP5 multimodel mean latitudinal structure of energy balance regimes remain unchanged by the end of the century with the exception of the Arctic (compare solid and dashed lines in Fig.~\ref{fig:cmip5-r1-ann-rcp}a). As modern regions of RCE remain in RCE, we expect modern $R_1$ to be a useful guide for the temperature response in the low latitudes. We additionally expect modern $R_1$ to be a useful guide over Antarctica, where it is in a state of RAE and $R_1$ remains largely unchanged.} %In the Arctic, the RAE regime contracts poleward from $75^\circ$N to $80^\circ$N. This is associated with a decrease in $R_1$ in the Arctic on the order of 0.1. In the Southern midlatitudes, $R_1$ increases by a similar magnitude but does not lead to a regime change.}

\added{The annual mean vertical temperature response to global warming is a clear function of the climatological energy balance regime, i.e. the value of modern $R_1$ (Fig.~\ref{fig:cmip5-r1-ann-rcp}b). In particular, the vertical temperature response to global warming in modern RCE exhibits amplified warming aloft (red lines, $R_1<0.1$ in Fig.~\ref{fig:cmip5-r1-ann-rcp}b) and in modern RAE regions exhibits amplified warming at the surface (blue lines, $R_1>0.9$ in Fig.~\ref{fig:cmip5-r1-ann-rcp}b).} 
...
\added{Next, we examine the seasonality of the CMIP5 multimodel mean change in energy balance regimes and $R_1$ (Fig.~\ref{fig:cmip5-dtemp}). Similar to the annual mean, modern regions of seasonal RCE remain in RCE by the end of the century (compare thick solid orange contour with the thick dashed orange contour in Fig.~\ref{fig:cmip5-dtemp}). Consistent with the expectation for a column that started and remains in RCE, amplified upper tropospheric warming occurs in modern regions of seasonal RCE, such as in the tropics and Northern midlatitudes during summertime (red filled contours in Fig.~\ref{fig:cmip5-dtemp}).}

\added{Over Antarctica, the change in $R_1$ is small through the seasonal cycle (on the order of 0.01, see black contours in Fig.~\ref{fig:cmip5-dtemp}). Consistent with the expectation for a column in RAE with no changes in $R_1$, the temperature response is amplified at the surface (blue filled contours in Fig.~\ref{fig:cmip5-dtemp}).}

\added{In contrast, the Arctic undergoes large seasonal changes in $R_1$ (on the order of 0.1), with a increase during May through August and a decrease during September through April (see black contours in Fig.~\ref{fig:cmip5-dtemp}). The temperature response over the Arctic also exhibits a large seasonality, with upper tropospheric warming coinciding with regions of $R_1$ increase, and vice versa. The Southern midlatitudes exhibits a similar response during December through April, where amplified upper tropospheric follows an increase in $R_1$.}
...
\begin{figure}
  ...
  \caption{\deleted{(a) }\added{Midlatitude (40$^\circ$--60$^\circ$) }$R_1$ seasonality measured by the minimum value of $R_1$ \deleted{and (b) surface temperature amplitude (half the difference of maximum and minimum temperatures) }predicted by the EBM (solid black line) and simulated by AQUA (stars). The orange region denotes the RCE regime.}
  \label{fig:amp-r1-echam}
\end{figure}

\begin{figure}[t]
    \noindent\includegraphics[width=\textwidth]{/project2/tas1/miyawaki/projects/002/figures/echam/rp000144/native/mid_mld/r1_mon_mld.png}\\
...
% \begin{figure}[t]
%     \noindent\includegraphics[width=\textwidth]{/project2/tas1/miyawaki/projects/002/figures_post/final/r1_decomp_pole/r1_decomp_pole_echamslab_mld_ga.pdf}\\
%     \caption{Seasonality of $R_1$ (black line, left axis) and boundary layer lapse rate deviation from a moist adiabat (blue line, right axis) in AQUA simulations with thermodynamic sea ice with (a) 50 m and (b) 35 m mixed layer depth.}
%     \label{fig:echam-rae-ga}
% \end{figure}
