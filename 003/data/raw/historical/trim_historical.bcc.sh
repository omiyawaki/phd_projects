...
declare -a vars_gcm=("hfss" "hfls") # list of GCM variables that we want to process
...
declare -a models=("bcc-csm1-1/") # list of GCM models to process
