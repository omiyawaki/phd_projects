...
declare -a vars_gcm=("ps" "tas" "ta" "hus" "zg") # list of GCM variables that we want to process
# declare -a vars_gcm=("divaht" "divte") # list of GCM variables that we want to process
...
declare -a models=("IPSL-CM5A-LR/") # list of GCM models to process
