...
for model in ${models[@]}; do
    ...
    if ls $cwd/${model}/r1a_${common} 1> /dev/null 2>&1; then # check if data is already there
        ...
        full_r1=${cwd}/${model}/r1a_${common}.nc

        python ${cwd}/make_r1a.py ${full_ra} ${full_stf} ${full_tend} ${full_stgadv} ${full_adv} ${full_r1}
    fi
