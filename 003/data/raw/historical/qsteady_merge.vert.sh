...
for model in ${models[@]}; do
    ...
    full_vqse=${cwd}/${model}/qsteady/vvqse_*.nc
    full_merge=${cwd}/${model}/vvqse_${common}.nc

    cdo -O mergetime $full_vqse $full_merge

    full_vqmmc=${cwd}/${model}/qsteady/vvqmmc_*.nc
    full_merge=${cwd}/${model}/vvqmmc_${common}.nc
