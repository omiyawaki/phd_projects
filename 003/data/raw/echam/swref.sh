...
for model in ${models[@]}; do
    ...
    if ls $cwd/${model}/swref_${common} 1> /dev/null 2>&1; then # check if data is already there
        ...
        python ${cwd}/make_swref.py ${full_sradsd} ${full_sradsu} ${full_srad0d} ${full_srad0u} ${full_alb} ${full_swref}
    fi
