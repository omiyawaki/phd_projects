...
# varnames=("ftoacs" "racs" "swtau" "swref" "swabs" "alb" "tradsu" "aclcov" "sni" "xlvi" "xivi" "aclcov" "prfrac" "ftoa" "twtend" "titend" "ttend" "stend" "sn" "ahfres" "tsi" "tsw" "ahfcon" "trafs" "sraf0" "traf0" "srafs" "srad0d" "srad0u" "fsfc" "tsurf" "sradsu" "albedo" "trads" "srads" "srad0" "trad0" "ahfl" "ahfs" "siced" "seaice" "temp2" "precip" "aprl" "aprc" "aps" "tend" "ra" "stf" "ra" "stgadv" "adv" "r1") # list of GCM variables that we want to process
# varnames=("trafs" "srafs" "sraf0" "traf0") # list of GCM variables that we want to process
# varnames=("tmelt" "smelt" "snmelt")
varnames=("t" "q" "rhumidity" "tendv")
# varnames=("ftoacs")
