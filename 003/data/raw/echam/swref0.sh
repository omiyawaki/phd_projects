...
for model in ${models[@]}; do
    ...
    if ls $cwd/${model}/swref0_${common} 1> /dev/null 2>&1; then # check if data is already there
        ...
        full_srad0u=${cwd}/${model}/srad0u_${common}.nc
        full_albedo=${cwd}/${model}/albedo_${common}.nc
        full_swref0=${cwd}/${model}/swref0_${common}.nc

        python ${cwd}/make_swref0.py ${full_sradsd} ${full_sradsu} ${full_srad0d} ${full_srad0u} ${full_albedo} ${full_swref0}
    fi
