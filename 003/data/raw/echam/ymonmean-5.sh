...
# varnames=("trads" "srads" "srad0" "trad0" "ahfl" "ahfs" "seaice" "temp2" "precip" "aprl" "aprc" "aps" "tend" "ra" "stf" "ra" "stgadv" "adv" "r1") # list of GCM variables that we want to process
# varnames=("tsurf" "trads" "srads" "ahfl" "ahfs" "fsfc") # list of GCM variables that we want to process
# varnames=("seaice" "siced")
varnames=("albedo" "sradsu" "seaice" "siced" "temp2" "tsurf" "trads" "srads" "ahfl" "ahfs" "fsfc")
