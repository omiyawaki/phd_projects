...
plt.tight_layout()
plt.savefig('./qflux_d.pdf', format='pdf', dpi=300)
...
plt.tight_layout()
plt.savefig('./qflux_ann_d.pdf', format='pdf', dpi=300)
...
fig.set_size_inches(5,3)
plt.tight_layout()
plt.savefig('./qflux_d_diff.pdf', format='pdf', dpi=300)
...
fig.set_size_inches(4,3)
plt.tight_layout()
plt.savefig('./qflux_ann_d_diff.pdf', format='pdf', dpi=300)
