...
ax.set_title('Seasonal cycle of Q-flux')
cbar = plt.colorbar(csf)
cbar.set_label('$Q_{\mathrm{flux}}$ (W m$^{-2}$)')
fig.set_size_inches(5,3)
plt.tight_layout()
plt.savefig('./qflux_b.pdf', format='pdf', dpi=300)
...
ax.set_title('Annual mean of Q-flux')
ax.yaxis.set_minor_locator(AutoMinorLocator())
fig.set_size_inches(4,3)
plt.tight_layout()
plt.savefig('./qflux_ann_b.pdf', format='pdf', dpi=300)
...
fig.set_size_inches(5,3)
plt.tight_layout()
plt.savefig('./qflux_b_diff.pdf', format='pdf', dpi=300)
