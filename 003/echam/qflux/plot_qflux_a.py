...
ds = xr.open_dataset('./qflux_ice40m_a.nc')
...
plt.tight_layout()
plt.savefig('./qflux_a.pdf', format='pdf', dpi=300)
...
ax.set_ylabel(r'$\overline{\Delta Q}$ (W m$^{-2}$)')
# ax.set_title('Annual-mean of DeltahQ-flux')
ax.yaxis.set_minor_locator(AutoMinorLocator())
fig.set_size_inches(4,3)
plt.tight_layout()
plt.savefig('./qflux_ann_a.pdf', format='pdf', dpi=300)
