...
for varname in varnames:
    ...
    q1[varname] = np.nanmean(np.roll(q1[varname],1,axis=0)[0:3,:],axis=0)
...
for varname in varnames:
    ...
    q2[varname] = np.nanmean(np.roll(q2[varname],1,axis=0)[0:3,:],axis=0)
...
for varname in varnames:
    ...
    q3[varname] = np.nanmean(np.roll(q3[varname],1,axis=0)[0:3,:],axis=0)
