...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{{/project2/tas1/miyawaki/projects/003/plotmerge/r1_mon_hl/mpi/r1_mon_hl.rcp85.ga_dev.mpi/r1_mon_hl.rcp85.ga_dev.mpi}.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{{/project2/tas1/miyawaki/projects/003/plotmerge/r1_mon_hl/mpi/r1_mon_hl.rcp85.prfrac.mpi/r1_mon_hl.rcp85.prfrac.mpi}.pdf}
    \caption{The evolution of $R_1$ (black, left axis) and the fraction of large-scale to total precipitation (blue, right axis) in the extended RCP8.5 run of MPI-ESM-LR for (a) fall (SON), (b) winter (DJF), and (c) spring (MAM).}
    \label{fig:r1-prfrac}
\end{figure}
    ...
    \item \textbf{TO DO}: make Fig.~\ref{fig:r1-mon-hl-allseas}, \ref{fig:r1-sice}, \ref{fig:r1-gadev}, and \ref{fig:r1-prfrac} for the CMIP5 multimodel mean.
\end{itemize}
...
\section{MSE flux divergence decomposition}
\begin{itemize}
