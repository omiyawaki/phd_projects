...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize}
    \item We decompose $\Delta R_1$ (where the change is taken relative to the 1975--2005 historical mean) into radiative and dynamic components following \cite{miyawaki2021} to show that the there are two phases to the temporal evolution of $R_1$: 1) the radiatively driven phase prior to the onset of the regime transition, and 2) the dynamically driven phase after the regime transition (Fig~\ref{fig:r1-decomp}a,b).
